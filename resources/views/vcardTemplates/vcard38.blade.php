                ...
                <div class="vcard-one__profile position-relative z-2 px-sm-5 px-4 py-5">
                    <div class="row gy-4 align-items-center">
                        ...
                        <div class="col-sm-7 order-sm-first">
                            ...
                            <p class="profile-meta text-white">{{ ucwords($vcard->occupation) }}</p>
                                <h2 class="profile-name text-white">{{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}</h2>
                                <h4 class="profile-name-2 text-grey">{{ ucwords($vcard->job_title) }} {{ ucwords($vcard->company) }}</h4>
                                <p class="profile-desc pt-4"><?php echo implode(' ', array_slice(explode(' ', $vcard->description), 0, 19))."\n"; ?>...</p>
                                @if (checkFeature('social_links') && getSocialLink($vcard))
                                <div class="social-icons d-flex  gap-3 pt-1 flex-wrap">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex flex-column align-items-center gap-3 px-sm-5 px-4">
                                ...
                                <p class="about-desc" style="color:gray;">{!! strip_tags($vcard->description)  !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row service-card align-items-center g-3 gy-4 mb-5">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                        class="text-decoration-none {{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                        target="{{ $service->service_url ? '_blank' : '' }}">
                                    <img src="{{ $service->service_icon }}" class="img-fluid position-relative" alt="{{ $service->name }}">
                                </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-sm-4 col-6">
                            <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images">
                                <img src="{{ $file->gallery_image }}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        @endif
            ...
            <section id="blog" class="py-5">
                <div class="container px-sm-4">
                    <div class="blogs-cards">
                        <h2 class="main-heading mb-5 text-center">{{ __('messages.feature.blog') }}</h2>
                        <div class="row">
                        <?php $count=0; ?>
                            ...
                            <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                                <div class="blog-img-1 blog-img main-blog position-relative">
                                    <img src="{{ $blog->blog_icon }}"
                                        class="img-fluid position-relative" alt="{{ $blog->title }}">
                                    <div class="overlay-black">
                                        <h5 class="blog-title">{{ $blog->title }}</h5>
                                        <p class="blog-desc"><?php echo implode(' ', array_slice(explode(' ', $blog->description ), 0, 10))."\n"; ?>... </p>
                                    </div>
                                </div>
                            </a>
                            </div>
                                    ...
                                    <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                                        <div class="blog-img2 blog-img position-relative">
                                            <img src="{{ $blog->blog_icon }}"
                                                class="img-fluid position-relative" alt="{{ $blog->title }}">
                                            <div class="overlay-black">
                                                <h5 class="blog-title-btm">{{ $blog->title }}</h5>
                                            </div>
                                        </div>
                                    </a>
                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-5 bg-black left py-4">
                                ...
                                <img src="{{asset('assets/img/vcard38/quote.png')}}" class="img-fluid qoute" alt="qoute">
                                <h3 class="testimonial-heading">{{ __('messages.plan.testimonials') }}</h3>
                                </div>
                        </div>
                        <div class="col-sm-7">
                                ...
                                <div class="testimonial-slide">
                                    <div class="testimonial-card g-3 position-relative">
                                        <div class="card-body text-center">
                                            ...
                                            <img src="{{ $testimonial->image_url }}" alt="profile" class="img-fluid testimonial-profile mb-3">
                                            <h4 class="card-title text-skyblue mb-1 lh-sm">{{ ucwords($testimonial->name) }}</h4>
                        ...
                        <div class="col-12">
                            <div class="appointment text-white">
                                ...
                                <div class="text-center">
                                    <label for="myID" class="form-label mb-3">{{ __('messages.hour') }}</label>
