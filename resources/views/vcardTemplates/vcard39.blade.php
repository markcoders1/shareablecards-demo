        ...
        <div class="vcard-one main-content w-100 mx-auto position-relative">
            ...
            <div class="vcard-one__profile position-relative z-2 px-4">
                <div class="d-flex flex-sm-row flex-column align-items-center gap-4">
                    ...
                    <div class="d-flex flex-column align-items-sm-start align-items-center  gap-1">
                        <h2 class="profile-meta">{{ ucwords($vcard->occupation) }}</h2>
                        <h2 class="profile-name text-pink">{{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}</h2>
                ...
                <div class="container">
                    <div class="row align-items-top g-3">
                        <div class="col-12 mb-3">
                            <h2 class="main-heading2 text-center">{{ __('messages.vcard.our_service') }}</h2>
                        </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                ...
                                <div class="service-img position-relative">
                                    <img src="{{ $service->service_icon }}" class="img-fluid rounded-top" alt="{{ $service->name }}">
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title" style="color: #fff;">{{ $service->name }}</h5>
                        ...
                        @foreach ($vcard->gallery as $file)
                            ...
                            <div class="gallery-card border-0">
                                ...
                                <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images">
                                    <img src="{{ $file->gallery_image }}" class="img-fluid" alt="gallery-1">
                                </a>
                                </div>
                            </div>
                        @endif
            ...
            <section id="blog" class="blog py-5">
                <div class="container">
                    <div class="row g-3">
                        <div class="col-12 mb-3">
                            <h2 class="main-heading2 text-center">{{ __('messages.feature.blog') }}</h2>
                        </div>
                        ...
                        <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                            <div class="blog-card card shadow-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text" style="color: #fff;"><?php echo implode(' ', array_slice(explode(' ', $blog->description), 0, 13))."\n"; ?> </p>
                                </div>
                            </div>
                        </a>
                        </div>
                                    ...
                                    <div class="testimonial-card row g-3 position-relative">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ $testimonial->image_url }}" alt="{{ ucwords($testimonial->name) }}" class="img-fluid testimonial-profile">
                                                <div class="d-flex flex-column">
