                ...
                <div class="vcard-one__profile position-relative z-2 px-sm-5 px-4 py-5">
                    <div class="row gy-4 align-items-center">
                        ...
                        <div class="col-sm-7 order-sm-first">
                            ...
                            <p class="top-position-profile">{{ ucwords($vcard->occupation) }}</p>
                                <h2 class="profile-name text-white">{{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }} </br><span class="text-skyblue profile-position">{{ ucwords($vcard->job_title) }} {{ ucwords($vcard->company) }}</span></h2>
                                <p class="profile-desc"><?php echo implode(' ', array_slice(explode(' ', $vcard->description), 0, 19))."\n"; ?>...</p>
                                @if (checkFeature('social_links') && getSocialLink($vcard))
                                <div class="social-icons d-flex  gap-3 pt-1 flex-wrap" style="width:100%;">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex flex-column align-items-center gap-3 px-sm-5 px-4">
                                ...
                                <p class="about-desc text-secondary">{!! strip_tags($vcard->description) !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="gallery" class="py-5">
                <div class="container px-sm-4">
                    <div class="blogs-cards2">
                        <h2 class="main-heading mb-4 text-center">{{ __('messages.plan.gallery') }}</h2>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images">
                                    <img src="{{ $file->gallery_image }}"
                                        class="img-fluid position-relative" alt="{{ $file->gallery_image }}">
                ...
                <div class="container">
                    <div class="row g-3">
                        <div class="col-12 mb-3">
                            <h2 class="main-heading">Get The Latest From The Blog</h2>
                        </div>
                        @foreach ($vcard->blogs as $blog)
                        <div class="col-sm-4">
                            <div class="blog-card card border-0">
                                <div class="blog-img position-relative">
                                <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"><img src="{{ $blog->blog_icon }}" class="img-fluid" alt="{{ $blog->title }}"></a>
                                </div>
                                <div class="card-body text-center">
                                <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"><h5 class="card-title">{{ $blog->title }}</h5></a>
