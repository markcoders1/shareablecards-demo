        ...
        <div
            ...
            <div class="vcard-two__banner w-100 position-relative">
                @if (strpos($vcard->cover_url, '.mp4') !== false ||
                    ...
                    <video class="cover-video img-fluid banner-image position-relative" loop autoplay muted playsinline
                        alt="background video" id="cover-video">
                        <source src="{{ $vcard->cover_url }}" type="video/mp4">
                    </video>
                @else
                    <img src="{{ $vcard->cover_url }}" class="img-fluid banner-image position-relative"
