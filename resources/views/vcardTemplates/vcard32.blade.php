...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500;1,600;1,700;1,800;1,900&family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    ...
    @include('vcards.password')
        <div class="vcard-one main-content w-100 mx-auto position-relative">
            ...
            <div class="vcard-one__banner w-100 position-relative">
                ...
                <div class="d-flex justify-content-end position-absolute top-0 end-0 me-3" style="z-index: 2;">
            ...
            {{--profile details--}}
            <div class="vcard-one__profile-details py-3 d-flex flex-column align-items-center justify-content-center bg-black">
                <div class="d-flex align-items-center gap-4 mt-4 w-100">
                    ...
                    <div class="main-heading text-center px-lg-3">
                        <h2 class="profile-name text-color-1">{{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}</h2>
                        <h2 class="profile-designation text-white">{{ ucwords($vcard->occupation) }}</h2>
                        <h2 class="profile-designation text-white">{{ ucwords($vcard->job_title) }}</h2>
                        <h2 class="profile-designation text-white">{{ ucwords($vcard->company) }}</h2>
                    </div>
                    <div class="flex-grow-1">
                        <div class="divider border-white"></div>
                    </div>
                    ...
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-sm-6">
                            <div class="contact-img">
                                <img src="{{asset('assets/img/vcard18/contact-img.png')}}" alt="profile-img" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="testimonial-card card bg-transparent border-0 shadow-0">
                                        <div class="card-body text-center">
                                            ...
                                            <div class="card-icon text-end">
                                                <img src="{{asset('assets/img/vcard18/blockquote.svg')}}"
                                                    alt="blockquote" class="img-fluid d-inline-block">
                                            </div>
                                            <h4 class="card-title">{{ ucwords($testimonial->name) }}</h4>
                                            <p class="card-text {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="appointment text-white">
                                <div class="mb-4">
                                    <label for="pickUpDate" class="form-label">{{ __('messages.date') }}</label>
                                    {{ Form::text('date', null, ['class' => 'appoint-input mb-2 form-control bg-black rounded-0 p-3', 'placeholder' => __('messages.form.pick_date'), 'id' => 'pickUpDate']) }}
                                </div>
