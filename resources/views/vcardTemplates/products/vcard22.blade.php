                ...
                <div class="row justify-content-between" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="col-4 mt-8 text-center">
                        <a class="back-btn text-decoration-none" id="product-back" href="{{ route('vcard.show', ['alias' => $vcard->url_alias]) }}"
                            data-button-style="{{ isset($vcard->dynamic_vcard) && !$vcard->dynamic_vcard->isEmpty() ? $vcard->dynamic_vcard[0]->button_style : 'default' }}" role="button">{{ __('messages.common.back') }}</a>
                    </div>
                </div>
                            ...
                            <div class="card product-card product-back px-2 border-0 w-75 w-sm-100 h-100 mx-auto mb-10">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="my-5 text-center">
                                        <button class="buy-product text-decoration-none" data-button-style="{{ isset($vcard->dynamic_vcard) && !$vcard->dynamic_vcard->isEmpty() ? $vcard->dynamic_vcard[0]->button_style : 'default' }}" data-id="{{ $product->id }}">{{ __('messages.subscription.buy_now') }}</button>
                                    </div>
                                @endif
                                </div>
                            </div>
