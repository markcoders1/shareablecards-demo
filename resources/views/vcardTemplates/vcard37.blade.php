...
<body>   
    ...
    <div class="vcard-one__profile position-relative z-2">
        <div class="avatar position-absolute start-50 translate-middle">
            <img src="{{ $vcard->profile_url }}" alt="profile-img" class="img-fluid" />
        </div>
    </div>
    <!-- {{--profile details--}} -->
    <div class="vcard-one__profile-details py-3 d-flex flex-column align-items-center justify-content-center">
        <div class="d-flex align-items-center gap-4 mt-4 w-100">
            ...
            <div class="main-heading text-center px-lg-3">
                <h2 class="profile-name text-white">{{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}</h2>
                <h2 class="profile-designation">{{ ucwords($vcard->occupation) }}</h2>
                <h2 class="profile-post">{{ ucwords($vcard->job_title) }} {{ ucwords($vcard->company) }}</h2>
            </div>
            <div class="flex-grow-1">
                <div class="divider border-white"></div>
            </div>
        </div>
        <span class="mt-4 profile-description mx-auto">{!! $vcard->description !!}</span>
        <div class="social-icons d-flex justify-content-center gap-3 pt-4">
        @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div class="social-icons d-flex justify-content-center gap-3 pt-4 flex-wrap w-75">
            ...
            <div class="row align-items-center g-3">
                <div class="col-sm-6 d-flex justify-content-center">
                    ...
                    @if ($vcard->dob)
                                    ...
                                    <svg style="margin-left: -7px;" xmlns="http://www.w3.org/2000/svg" width="25" height="22" viewBox="0 0 25 22" fill="none">
                                            ...
                                            <defs fill="#000000">
                                                <clipPath id="clip0_224_569" fill="#000000">
                                                    <rect width="25" height="22" fill="#c29bf4"/>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </div>
                        ...
                        @if ($vcard->location)
                        <div class="d-flex align-items-center gap-3">
                            <div class="contact-icon" style="margin-right: 7px;">
    ...
    <section id="services" class="services bg-color-1 pb-5">
        ...
        <div class="d-flex align-items-center gap-4 my-3 w-100">
            ...
            <h2 class="main-heading text-center px-lg-3">{{ __('messages.vcard.our_service') }}</h2>
            <div class="flex-grow-1">
                <div class="divider border-black"></div>
            </div>
        </div>
    ...
    <section id="gallery" class="gallery-wrapper">
        <div class="d-flex align-items-center gap-4 mb-3 pt-5 w-100">
            ...
            <h2 class="main-heading text-center px-lg-3 text-white">{{ __('messages.plan.gallery') }}</h2>
            <div class="flex-grow-1">
                <div class="divider border-white"></div>
            </div>
        </div>
                ...
                <div class="col-12 px-0">
                    ...
                    @foreach ($vcard->gallery as $file)
                        ...
                        <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images">
                            <img src="{{ $file->gallery_image }}" alt="gallery-img" class="img-fluid">
                            </a>
                        </div>
                    @endif
                    @endforeach
    ...
    <section id="testimonial" class="testimonial pb-5">
        <div class="d-flex align-items-center gap-4 my-5 w-100">
            ...
            <h2 class="main-heading text-center px-lg-3">{{ __('messages.plan.testimonials') }}</h2>
            <div class="flex-grow-1">
                <div class="divider border-black"></div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="testimonial-slider-2 slider-dots mx-auto">
                        <!-- slider 1 -->
                        ...
                        <div class="testimonial-slide">
                            <div class="testimonial-card row g-3 position-relative">
                                ...
                                <div class="col-sm-5 d-flex flex-column gap-3 flex-grow-1 testimonial-image">
                                    <img src="{{ $testimonial->image_url }}" class="img-fluid" alt="testimonial">
                                </div>
                                <div class="col-sm-7 d-flex flex-column gap-4 flex-grow-1">
                                    <div class="card bg-transparent border-0 shadow-0">
                                        <div class="card-body2 px-2 pb-0">
                                            ...
                                            <h4 class="card-title lh-sm">{{ ucwords($testimonial->name) }}</h4>
    ...
    <section id="blog" class="blog bg-color-1 pb-5">
        <div class="d-flex align-items-center gap-4 my-5 w-100">
            ...
            <h2 class="main-heading text-center px-lg-3">{{ __('messages.feature.blog') }}</h2>
            <div class="flex-grow-1">
                <div class="divider border-black"></div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    @foreach ($vcard->blogs as $blog)
                        ...
                        <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                            <div class="card text-bg-dark blog-content">
                                <img src="{{ $blog->blog_icon }}" class="card-img rounded-0" alt="{{ $blog->title }}">
                ...
                <div class="col-12">
                    <div class="appointment text-white">
                        <div class=" mb-4">
                            ...
                            {{ Form::text('date', null, ['class' => 'appoint-input mb-2 form-control rounded-0 p-3', 'placeholder' => __('messages.form.pick_date'), 'id' => 'myID']) }}
                        </div>
                        <div class="mb-5">
