        ...
        <div class="vcard-one main-content w-100 mx-auto position-relative">
            ...
            <div class="vcard-one__profile position-relative z-2 px-4">
                <div class="d-flex flex-sm-row flex-column align-items-center gap-4">
                    ...
                    <div class="d-flex flex-column align-items-sm-start align-items-center">
                        <h2 class="profile-name text-sand">{{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }} @if ($vcard->job_title) ({{ ucwords($vcard->job_title) }})@endif</h2>
                        <h2 class="profile-designation text-white">{{ ucwords($vcard->occupation) }} {{ ucwords($vcard->company) }}</h2>
                        <div class="social-icons d-flex justify-content-center gap-3 pt-3 flex-wrap">
                    ...
                    @foreach ($vcard->testimonials as $testimonial)
                        <div class="col-md-4 px-2">
                            ...
                            <div class="circle">
                                ...
                                <a href="#"></a><h3 class="testimonials-box-heading lh-sm">{{ ucwords($testimonial->name) }}</h3></a>
                                <p class="testimonials-box-text {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">{!! $testimonial->description !!}</p>
                            </div>
                        </div>
                    @endforeach
                    </div>
            ...
            <section id="appointment" class="appointment-wrapper py-3">
                <div class="container pb-5">
                    <div class="row">
                        <div class="col-12 mb-4">
                            <h2 class="main-heading2 appointment-headin text-center">{{ __('messages.make_appointments') }}</h2>
                        </div>
                        <div class="col-12">
                            <div class="appointment text-white">
                                ...
                                <div class="text-center">
                                    <label for="myID" class="text-white mb-3">{{ __('messages.hour') }}</label>
