            ...
            <div class="vcard-one__profile position-relative z-2 px-4">
                <div class="d-flex flex-sm-row flex-column align-items-center gap-4">
                    ...
                    <div class="d-flex flex-column align-items-sm-start align-items-center  gap-1">
                        <p class="profile-company">{{ ucwords($vcard->occupation) }}</p>
                        <h2 class="profile-name text-skyblue">{{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}</h2>
                        <h2 class="profile-designation text-white">{{ ucwords($vcard->job_title) }} {{ ucwords($vcard->company) }}</h2>
                        @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div class="social-icons d-flex justify-content-center gap-3 pt-1 flex-wrap">
            ...
            <section id="contact-us" class="my-5">
                <div class="container px-sm-4">
                    ...
                    @if ($vcard->dob)
                        <div class="col-sm-6 col-12">
                            <div class="contact-box d-flex align-items-center gap-3">
                                <div class="contact-icon" style="margin-left: -4px;">
                ...
                <div class="container py-5 bg-navy-blue px-4">
                    <div class="row align-items-center g-3 gy-4">
                        <div class="col-sm-6 col-12 text-center">
                            <div class="about-img">
                                <img src="{{ $vcard->profile_url }}" class="img-fluid" alt="about-img">
                            </div>
                        </div>
                        <div class="col-sm-6 col-12">
                ...
                <div class="container">
                    <div class="row align-items-top g-3">
                        <div class="col-12 mb-3">
                            <h2 class="main-heading text-center">{{ __('messages.vcard.our_service') }}</h2>
                        </div>
                        ...
                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                            ...
                            <div class="service-card card shadow-0">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title" style="color:#fff;">{{ ucwords($service->name) }}</h5>
                                    <p class="card-text {{ \Illuminate\Support\Str::length($service->description) > 80 ? 'more' : '' }}" style="color:#fff;">{!! $service->description !!}</p>
                                </div>
                            </div>
                        </a>
                        </div>
        ...
        @endphp
                    ...
                    <div class="row g-3 justify-content-center">
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="hours-box bg-navy-blue-2">
                                <h6 class="hours-title text-center">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }} : {{ $dayTime ?? __("messages.common.closed") }}</h6>
                            </div>
                        </div>
                        @endforeach
                    </div>
                        ...
                        <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                            <div class="blog-card card shadow-0">
                                <div class="blog-img position-relative">
                                    <img src="{{ $blog->blog_icon }}" class="img-fluid rounded-top" alt="{{ $blog->title }}">
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title" style="color: #fff;">{{ $blog->title }}</h5>
                                    <p class="card-text" style="color: #fff;"><?php echo implode(' ', array_slice(explode(' ', $blog->description), 0, 15))."\n"; ?> </p>
                                </div>
                            </div>
                        </a>
                        </div>
            ...
            <section id="testimonial" class="testimonial bg-navy-blue py-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <h2 class="main-heading text-center">{{ __('messages.plan.testimonials') }}</h2>
                        </div>
                        <div class="col-12">
                                    ...
                                    <div class="testimonial-card row g-3 position-relative">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ $testimonial->image_url }}" alt="profile" class="img-fluid testimonial-profile">
                                                <div class="d-flex flex-column">
                                                    <h4 class="card-title text-skyblue lh-sm">{{ ucwords($testimonial->name) }}</h4>
                ...
                <div class="container pb-5">
                    <div class="row">
                        <div class="col-12 mb-4">
                            <h2 class="main-heading text-center">{{ __('messages.make_appointments') }}</h2>
                        </div>
                        <div class="col-12">
                            <div class="appointment text-white">
                                ...
                                <div class="text-center">
                                    <label for="myID" class="form-label text-skyblue mb-3">{{ __('messages.hour') }}</label>
                                    <div class="justify-content-sm-between justify-content-center gap-3">
                                    <div id="slotData" class="row">
                                    </div>
                                    </div>
                                </div>
                                <button type="submit" class="appointmentAdd btn btn-appointment mt-4">{{ __('messages.make_appointments') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
