...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-60">
                    <div class="template-card h-100">
                        <div class="card-img">
                            <img src="{{ asset('assets/img/templates/vcard34.png') }}" class="w-100 img-fluid">
                        </div>
                        <div class="card-body p-0 pt-4 mt-1">
                            <h6 class="fs-20 text-center">Creative Director (Design/Tech)</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-60">
                    <div class="template-card h-100">
                        <div class="card-img">
                            <img src="{{ asset('assets/img/templates/vcard35.png') }}" class="w-100 img-fluid">
                        </div>
                        <div class="card-body p-0 pt-4 mt-1">
                            <h6 class="fs-20 text-center">Chief Officer (Cybersecurity)</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-60">
                    <div class="template-card h-100">
                        <div class="card-img">
                            <img src="{{ asset('assets/img/templates/vcard36.png') }}" class="w-100 img-fluid">
                        </div>
                        <div class="card-body p-0 pt-4 mt-1">
                            <h6 class="fs-20 text-center">Financial Advisor (Corporate)</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-60">
                    <div class="template-card h-100">
                        <div class="card-img">
                            <img src="{{ asset('assets/img/templates/vcard37.png') }}" class="w-100 img-fluid">
                        </div>
                        <div class="card-body p-0 pt-4 mt-1">
                            <h6 class="fs-20 text-center">Event Planner (Lifestyle)</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-60">
                    <div class="template-card h-100">
                        <div class="card-img">
                            <img src="{{ asset('assets/img/templates/vcard38.png') }}" class="w-100 img-fluid">
                        </div>
                        <div class="card-body p-0 pt-4 mt-1">
                            <h6 class="fs-20 text-center">Attorney (Legal Services)</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-60">
                    <div class="template-card h-100">
                        <div class="card-img">
                            <img src="{{ asset('assets/img/templates/vcard39.png') }}" class="w-100 img-fluid">
                        </div>
                        <div class="card-body p-0 pt-4 mt-1">
                            <h6 class="fs-20 text-center">Hair Stylist (Beauty)</h6>
                        </div>
                    </div>
                </div>
    ...
    <section class="features-section" id="frontFeatureTab" style="margin-bottom:2rem;">
        <div class="container">
            <h2 class="heading text-center margin-b-80px">
                {{__('messages.plan.features')}}
            </h2>
            <div class="row" style="--bs-gutter-y:2.5rem; gap: 20px;">

                @foreach($features as $feature)
                <div class="col-lg-4 col-md-6 features-section__block border rounded-20" style="padding:0;" >
                    <div class="features-section__features-inner" style="padding:30px; border-radius:1.25rem;" >
                            <div class="features__features-icon text-white fs-2 d-flex align-items-center">
                                <i class="mdi mdi-trophy-variant-outline"></i>
                                <img src="{{ $feature->profile_image }}" alt="" class="feature-image feature-image-card image-object-fit-cover" style="width:70px; object-fit:cover;border-radius:8px; margin-bottom: 30px;" >
                            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
					<div class="contact-img ">
                        <img src="{{ asset('assets/img/new_home_page/contact-image.png') }}" alt="contact"
