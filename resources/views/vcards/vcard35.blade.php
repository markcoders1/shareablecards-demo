    ...
    <div class="container">
        <div class="vcard-one main-content w-100 mx-auto">
            ...
            <div class="vcard-one__banner w-100 position-relative">
                <img src="{{asset('assets/img/vcard35/hero-image.png')}}" class="img-fluid" alt="background image" />
                        ...
                        <ul class="text-decoration-none">
                            <li class="dropdown1 dropdown lang-list">
                                ...
                                <ul class="dropdown-menu start-0 lang-hover-list top-100 image-icon">
                                    <li>
                                        <img src="{{asset('assets/img/vcard35/english.png')}}" width="25px" height="20px" class="me-3"><a href="#">English</a>
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/vcard35/spain.png')}}" width="25px" height="20px" class="me-3"><a href="#">Spanish</a>
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/vcard35/france.png')}}" width="25px" height="20px" class="me-3"><a href="#">Franch</a>
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/vcard35/arabic.svg')}}" width="25px" height="20px" class="me-3"><a href="#">Arabic</a>
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/vcard35/german.png')}}" width="25px" height="20px" class="me-3"><a href="#">German</a>
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/vcard35/russian.jpeg')}}" width="25px" height="20px" class="me-3"><a href="#">russian</a>
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/vcard35/turkish.png')}}" width="25px" height="20px" class="me-3"><a href="#">Turkish</a>
                                    </li>
            ...
            <div class="vcard-one__profile position-relative z-2 px-4">
                <div class="d-flex flex-sm-row flex-column align-items-center gap-4">
                    <div class="avatar">
                        <img src="{{asset('assets/img/vcard35/vcard1-profile1.png')}}" alt="profile-img" class="img-fluid" />
                    </div>
                    <div class="d-flex flex-column align-items-sm-start align-items-center  gap-1">
                        <p class="profile-company">Cyber Security Services</p>
                        <h2 class="profile-name text-skyblue">Micheal Daniels</h2>
                        <h2 class="profile-designation text-white">Chief Technology Officer</h2>
            ...
            <scrtion id="about">
                <div class="container py-5 bg-navy-blue px-4">
                    <div class="row align-items-center g-3 gy-4">
                        <div class="col-sm-6 col-12 text-center">
                            <div class="about-img">
                                <img src="{{asset('assets/img/vcard35/about-img.png')}}" class="img-fluid" alt="about-img">
                            </div>
                        </div>
                        <div class="col-sm-6 col-12">
                ...
                <div class="container">
                    <div class="row align-items-top g-3">
                        <div class="col-12 mb-3">
                            <h2 class="main-heading text-center">MY SERVICES</h2>
                        </div>
                        <div class="col-sm-4">
                            <div class="service-card card shadow-0">
                                <div class="service-img position-relative">
                                    <!-- <img src="{{asset('assets/img/vcard35/blog-1.png')}}" class="img-fluid" alt="service-card-1"> -->
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="service-card card shadow-0">
                                <div class="service-img position-relative">
                                    <!-- <img src="{{asset('assets/img/vcard35/blog-2.png')}}" class="img-fluid" alt="service-card-1"> -->
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title">Loremipsum</h5>
                                    <p class="card-text">It is a long established fact that a reader will be distracted by the readable content of a page.</p>
                        ...
                        <div class="col-sm-4">
                            <div class="service-card card shadow-0">
                                <div class="service-img position-relative">
                                    <!-- <img src="{{asset('assets/img/vcard35/blog-3.png')}}" class="img-fluid" alt="service-card-1"> -->
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title">Loremipsum</h5>
                                    <p class="card-text">It is a long established fact that a reader will be distracted by the readable content of a page.</p>
                        ...
                        <div class="col-sm-4">
                            <div class="blog-card card shadow-0">
                                <div class="blog-img position-relative">
                                    <img src="{{asset('assets/img/vcard35/blog-1.png')}}" class="img-fluid rounded-top" alt="service-card-1">
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title">Loremipsum</h5>
                                    <p class="card-text">It is a long established fact that a reader will be distracted by the readable content of a page.</p>
            ...
            {{--testimonial--}}
            <section id="testimonial" class="testimonial bg-navy-blue py-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <div class="testimonial-slider mx-auto">
                                ...
                                <div class="testimonial-slide">
                                    <div class="testimonial-card row g-3 position-relative">
                                        <img src="{{asset('assets/img/vcard35/qoute.svg')}}" class="img-fluid qoute" alt="qoute">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{asset('assets/img/vcard35/profile.png')}}" alt="profile" class="img-fluid testimonial-profile">
                                                <div class="d-flex flex-column">
                                                    <h4 class="card-title text-skyblue">MARK HENRY</h4>
                ...
                <div class="container pb-5">
                    <div class="row">
                        <div class="col-12 mb-4">
                            <h2 class="main-heading text-center">Make an Appointment</h2>
                        </div>
                        <div class="col-12">
                            <form class="appointment text-white">
                                ...
                                <div class="text-center">
                                    <label for="myID" class="form-label text-skyblue mb-3">Hours</label>
