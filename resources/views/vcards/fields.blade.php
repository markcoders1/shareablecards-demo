...
@if ($partName == 'templates')
    <div class="container-fluid">
        ...
        <div class="col-lg-12 mt-2 d-flex">
            <button class="btn btn-primary me-3 template-save" id="save-button">
                @if(is_array($vcard))
                    @if($vcard->template_id>=31)
                    <?php
                    if($managesection["insta_embed"]=="1"){
                        VcardSections::where("id",$vcard->id)->update(["insta_embed"=>"0"]);
                    };
                    if($managesection["iframe"]=="1"){
                        VcardSections::where("id",$vcard->id)->update(["iframe"=>"0"]);
                    };
                    if($managesection["map"]=="1"){
                        VcardSections::where("id",$vcard->id)->update(["map"=>"0"]);
                    };
                    ?>
                    @endif
                @endif
    ...
    <div class="container-fluid">
        <div class="row mt-5">
            ...
            <div class="row mt-5">
                ...
                @endif
                <div class="col-6 mt-5" title = "{{ $vcard->template_id > 31 ? 'Map is disabled for this template' : '' }}">
                ...
                @if (checkFeature('insta_embed'))
                    <div class="col-6 mt-5" title = "{{ $vcard->template_id > 31 ? 'Insta Embed is disabled for this template' : '' }}">
                ...
                @if (checkFeature('iframes'))
                    <div class="col-6 mt-5" title = "{{ $vcard->template_id > 31 ? 'Iframes are disabled for this template' : '' }}">
