    ...
    <div class="container">
        <div class="vcard-one main-content w-100 mx-auto">
            ...
            <div class="vcard-one__banner w-100 position-relative">
                <img src="{{asset('assets/img/vcard33/main-banner.png')}}" class="img-fluid" alt="background image" />
                ...
                <div class="vcard-one__profile-details text-white py-3 d-flex flex-column align-items-start">
                    <p class="profile-oc">Better Staffing</p>
                    <h3 class="profile-name-first">MY NAME IS</h3>
                    <h2 class="profile-name-last">Cynthia Riley</h2>
                    <h2 class="profile-designation">CEO OF MICROSOFT</h2>
                    ...
                    <div class="row gy-5">
                        <div class="col-sm-6 col-12">
                            <div class="about-img-wrapper d-flex justify-content-center pt-4">
                                <div class="about-img">
                                    <img src="{{asset('assets/img/vcard33/about.png')}}" class="img-fluid"
                                        alt="about" />
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="d-flex flex-column gap-3 text-navy-blue">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <a href="#" class="contact-link text-navy-blue">say.hi
                                                    @shareable.icu</a>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <a href="#" class="contact-link text-navy-blue">+12 3456 7890</a>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="contact-icon">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <a href="#" class="contact-link text-navy-blue">www.shareable.icu</a>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="contact-icon">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <a href="#" class="contact-link text-navy-blue">City, State, Country</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    class="social-icons d-flex justify-content-sm-start justify-content-center gap-3 pt-4">
                ...
                <div class="container px-sm-4">
                    <div class="row gy-4">
                        <div class="col-12 mb-5">
                            <h2 class="main-heading">Qualifications</h2>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex flex-column gap-4">
                                <h4 class="qualification-title">Education</h4>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex flex-column gap-4">
                                <h4 class="qualification-title">Experience</h4>
                                <div class="qualification-card position-relative">
                                    <div class="card-arrow"></div>
                                    <div class="card-body px-4">
                                        <h3 class="card-title">IOT Technologies</h3>
                                        <p class="card-text">It is a long established fact that a reader will be
                                            distracted by the readable content of a page when looking at its layout.</p>
                                    </div>
                                </div>
                ...
                <div class="container px-sm-4">
                    <div class="row g-2">
                        <div class="col-12 mb-4">
                            <h2 class="main-heading">My Work</h2>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-1.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-1.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-2.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-2.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-3.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-3.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-4.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-4.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-5.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-5.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-6.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-6.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-7.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-7.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-8.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-8.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                        <div class="col-sm-4 col-6">
                            <a href="{{asset('assets/img/vcard33/gallery-9.png')}}" data-lightbox="gallery-images">
                                <img src="{{asset('assets/img/vcard33/gallery-9.png')}}" class="img-fluid"
                                    alt="gallery">
                            </a>
                        </div>
                    </div>
            ...
            <section id="blog" class="blog">
                <div class="container">
                    <div class="row">
                        <div class="col-12 mb-4">
                            <h2 class="main-heading text-white">My Blog</h2>
                        </div>
                        <div class="col-12">
                            <div class="blog-slider-2 mx-auto mb-4">
                                <div class="blog-slide">
                                    <div class="card text-bg-dark">
                                        <img src="{{asset('assets/img/vcard33/blog-1.png')}}" class="card-img rounded-0"
                                            alt="blog-img">
                                ...
                                <div class="blog-slide">
                                    <div class="card text-bg-dark">
                                        <img src="{{asset('assets/img/vcard33/blog-2.png')}}" class="card-img rounded-0"
                                            alt="blog-img">
                                        <div class="card-img-overlay">
                                            <h5 class="card-title">Loremipsum</h5>
                                        </div>
                                ...
                                <div class="blog-slide">
                                    <div class="card text-bg-dark">
                                        <img src="{{asset('assets/img/vcard33/blog-3.png')}}" class="card-img rounded-0"
                                            alt="blog-img">
                                        <div class="card-img-overlay">
                                            <h5 class="card-title">Loremipsum</h5>
                                        </div>
                            ...
                            <div class="testimonial-slider-2 mx-auto">
                                ...
                                <div class="testimonial-slide">
                                    <div class="testimonial-card position-relative">
                                        ...
                                        <div class="d-flex flex-column">
                                            <img src="{{asset('assets/img/vcard33/testimonial-profile.png')}}"
                                                class="testimonial-profile" alt="profile">
                                            <h4 class="profile-name">Rose Edison</h4>
                        ...
                        <div class="col-12">
                            <form class="appointment text-white text-center">
                                <div class="mb-4 position-relative">
                                    <img src="{{asset('assets/img/vcard33/calender.svg')}}"
                                        class="position-absolute end-0 top-50 translate-middle" alt="qoute">
                                    <input id="myID" type="text"
                                        class="appoint-input mb-2 form-control bg-transparent text-center text-white rounded-0 p-3 position-relative"
